...
const testProps = {"activeGalaxy":{"name":"Galaxy #1","id":"testId","color":"#1ab579","distance":2, "velocity":1}, "selectedData":[{id: "galaxy", stuff: "things"}, {id: "supernova", stuff: "things"}],"className":"md-btn--toolbar"};
